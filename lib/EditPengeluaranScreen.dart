...
class EditPengeluaranScreen extends StatefulWidget {
  final Pengeluaran pengeluaran;

  const EditPengeluaranScreen({Key? key, required this.pengeluaran})
      : super(key: key);

  @override
  _EditPengeluaranScreenState createState() => _EditPengeluaranScreenState();
}

class _EditPengeluaranScreenState extends State<EditPengeluaranScreen> {
  ...
  void initState() {
    super.initState();
    _amountController.text = widget.pengeluaran.amount.toString();
    _noteController.text = widget.pengeluaran.note;
    _selectedCategory = widget.pengeluaran.category;
    _selectedDate = widget.pengeluaran.date;
